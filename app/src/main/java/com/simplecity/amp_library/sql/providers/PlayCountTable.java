...
public class PlayCountTable extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        if (oldVersion < 2) {
            ...
            final String tableBackup = "BACKUP";
            ...
            try {
                final String countInfoDatabase = "count_info.db";
                final String pathCountInfo = applicationContext.getDatabasePath(countInfoDatabase).toString();
                final String tableCountInfo = "COUNT_INFO";
                final String countInfoColumnId = "_id";
                final String countInfoColumnTimePlayed = "time_played";
